// ASCII 32..126 of KiCad's "newstroke" stroke font (CC0 / public domain,
// from kicad/common/newstroke_font.cpp). Encoding: first two chars are the
// left/right bounds (c - 'R'); then coordinate pairs x=(c0-'R'), y=(c1-'R')
// with " R" as pen-up. Divide by 21 and scale by the text size; y offset -10.
#pragma once
namespace routing {
inline const char* const kNewstrokeAscii[95] = {
    "JZ",
